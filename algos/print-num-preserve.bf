...
/*
	...
	First, copy x to x1, ending on x1. Hereafter, x will now mean "x1".
*/
[->>+<<]>>[-<+<+>>]<


/*
	MEM: >x1 - assume all cells to the right are 0

	Then, make room for our print buffer. We're going to use 0 as a stop
...
/* Lastly, go back one cell to end on the original x (not x1) */
<
